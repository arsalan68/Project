        ...
        <>
            <div className='Pagebackground'>
                <div className="container">
                    <div className="row ">
                        <div className="col-md-6 text-white mt-5 text-start">
                            <h6 className='text-danger' ><svg xmlns="http://www.w3.org/2000/svg" width="40" height="16" viewBox="0 0 40 16" fill="none"><rect x="0.5" y="0.5" width="25.6667" height="15" rx="7.5" stroke="#384BFF"></rect><rect x="13.3334" width="26.6667" height="16" rx="8" fill="#384BFF"></rect></svg> BEST IT SOULTION PROVIDER</h6>
            ...
            <div className='container'>
                <div className="row">
                    ...
                    <div className="col-md-6 mt-5">
                        ...
                        <div className="row mt-4 w-50  mx-5">
